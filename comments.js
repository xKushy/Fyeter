...
import { getFirestore, collection, addDoc, onSnapshot, serverTimestamp, doc, query, orderBy, updateDoc } from "https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore.js";
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const goToFeedButton = document.getElementById('goToFeedButton');
  ...
  onAuthStateChanged(auth, user => {
    if (user) {
      ...
      goToFeedButton.addEventListener('click', () => {
